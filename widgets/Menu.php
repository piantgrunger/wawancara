...
class Menu extends \yii\widgets\Menu
{
     ...
     * @inheritdoc
     */
    public $linkTemplate = '<li class="{show}"><a href="{url}" class="nav-link" >{icon} <span>{label}</span></a></li>';
    /**
     * @inheritdoc
    ...
    public function run()
    {
        ...
        if (!empty($items)) {
            ...
            $tag = null; //ArrayHelper::remove($options, 'tag', 'ul');
    ...
    {
        if (isset($item['items'])) {
            $labelTemplate = '<li class="dropdown {show}"> <a href="{url}" class="nav-link has-dropdown">{icon} {label} </a>';
            $linkTemplate = '<li class="dropdown {show}"><a href="{url}" class="nav-link has-dropdown">{icon} {label} </a>';
        } else {
    ...
    protected function renderItems($items)
    {
        ...
        foreach ($items as $i => $item) {
            ...
            $tag = null;// ArrayHelper::remove($options, 'tag', 'li class="sidebar-item"');
            $class = [];
            if ($item['active']) {
